...
const CreateQuiz = () => {
  const form = useForm<Quiz>({
    initialValues: {
      title: "",
      description: "",
      category: EQuizCategories.OTHER,
      questions: [],
    },
    validate: {
      ...
      <Grid gutter={"xl"} align="center">
        ...
        <Grid.Col span={8} pr={0}>
          <Select
            ...
            data={Object.values(EQuizCategories).map((category) => ({
              value: category,
              label: category,
            }))}
        ...
        {form.values.questions.map((question, index) => (
          <>
            <Grid.Col span={12} key={`question_${index}_header`} pr={0}>
            ...
            <Grid.Col span={8} key={`question_${index}_text_input`} pr={0}>
              <TextInput
                required
            ...
            <Grid.Col span={8} key={`question_${index}_type_input`} pr={0}>
              <Select
                required
